            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">
                        ...
                        <?php endif; ?>
                        Layanan</h4>
                    <?= form_open_multipart('ppobbanner/ubah/' . $id); ?>
                    <input type="hidden" name="id" value='<?= $id ?>'>
                    <div class="form-group">
                        <input type="file" class="dropify" name="foto" data-max-file-size="3mb" data-default-file="<?= base_url('images/ppob/banner/') . $foto ?>" />
                    </div>
