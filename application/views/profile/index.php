                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info">
                                ...
                                <div class="form-group">
                                    <input type="hidden" class="form-control" id="valid" name="id" style="width:60%" value="<?= $id ?>" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password" id="password" placeholder="change password here" required>
                                    </div>
                                    <div class="form-group mt-5">
