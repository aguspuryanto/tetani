...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title><?=$this->config->item("app_name");?> Admin</title>
    <!-- plugins:css -->
                    ...
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <?php endif; ?>
                                <h2>Masuk</h2>
                                <h4 class="font-weight-light">Hay , Selamat Datang.</h4>
                                ...
                                <div class="mt-5">
                                    ...
                                    <br>
                                    <span class="text-muted d-block text-center  justify-center ">Copyright © 2020 <a class="text-success" href="#"><?=$this->config->item("app_name");?></a>.</span>
                                </div>
                                <?= form_close(); ?>
                            </div>
                        </div>
