...
class Merchant extends REST_Controller
{
    ...
    function login_post()
    {
        ...
        if ($check_banned) {
            ...
            $cek_login = $this->Merchantapi_model->cek_data_merchant($condition);
    ...
    function inbox_post()
    {
        ...
        $listinbox = $this->Merchantapi_model->datainbox($decoded_data->id);
    ...
    function chat_post()
    {
            ...
            $this->Merchantapi_model->insertchat($datachat,$decoded_data->fotochat,$namafoto);
            $message = array(
                'message' => 'sukses'
            );
            $this->response($message, 200);
   ...
   function getchat_post(){
        ...
        $datachat = $this->Merchantapi_model->datachat($decoded_data->idtrans);
        $message = array(
            'message' => 'sukses',
            'data' => $datachat
        );
